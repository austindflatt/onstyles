...
declare const _default: (params: AvatarStyles, options?: import("@mantine/styles/lib/tss/create-styles").UseStylesOptions<"image" | "placeholder" | "root" | "placeholderIcon">) => {

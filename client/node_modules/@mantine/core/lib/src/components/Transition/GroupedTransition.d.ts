...
export declare function GroupedTransition({ transitions, duration, mounted, children, timingFunction, onExit, onEntered, onEnter, onExited, }: GroupedTransitionProps): JSX.Element;

...
export declare type ModalStylesNames = Exclude<ClassNames<typeof useStyles>, 'clickOutsideOverlay'>;
...
export declare function MantineModal({ className, opened, title, onClose, children, hideCloseButton, overlayOpacity, size, transitionDuration, closeButtonLabel, overlayColor, zIndex, overflow, transition, padding, shadow, id, classNames, styles, sx, closeOnClickOutside, ...others }: ModalProps): JSX.Element;

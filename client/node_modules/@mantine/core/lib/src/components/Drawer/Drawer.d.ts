...
export declare type DrawerStylesNames = Exclude<ClassNames<typeof useStyles>, 'noOverlay' | 'clickOutsideOverlay'>;
...
export declare function MantineDrawer({ className, style, opened, onClose, position, size, noFocusTrap, noScrollLock, noCloseOnClickOutside, noCloseOnEscape, transition, transitionDuration, transitionTimingFunction, zIndex, overlayColor, overlayOpacity, children, noOverlay, shadow, padding, title, hideCloseButton, closeButtonLabel, classNames, styles, sx, ...others }: DrawerProps): JSX.Element;

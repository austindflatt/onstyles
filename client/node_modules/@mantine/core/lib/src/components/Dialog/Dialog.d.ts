...
export declare function MantineDialog({ withCloseButton, onClose, position, shadow, padding, zIndex, children, className, style, classNames, styles, opened, withBorder, size, transition, transitionDuration, transitionTimingFunction, sx, ...others }: DialogProps): JSX.Element;

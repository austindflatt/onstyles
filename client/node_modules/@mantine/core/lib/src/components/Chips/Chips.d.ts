...
export declare function Chips<T extends boolean>({ value, defaultValue, onChange, color, spacing, radius, size, variant, multiple, children, id, classNames, styles, sx, ...others }: ChipsProps<T>): JSX.Element;

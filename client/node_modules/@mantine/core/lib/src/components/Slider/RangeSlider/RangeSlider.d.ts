...
export declare function RangeSlider({ classNames, styles, color, value, onChange, size, radius, min, max, minRange, step, defaultValue, name, marks, label, labelTransition, labelTransitionDuration, labelTransitionTimingFunction, labelAlwaysOn, thumbFromLabel, thumbToLabel, showLabelOnHover, ...others }: RangeSliderProps): JSX.Element;

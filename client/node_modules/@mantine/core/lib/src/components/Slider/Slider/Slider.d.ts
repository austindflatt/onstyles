...
export declare function Slider({ classNames, styles, color, value, onChange, size, radius, min, max, step, defaultValue, name, marks, label, labelTransition, labelTransitionDuration, labelTransitionTimingFunction, labelAlwaysOn, thumbLabel, showLabelOnHover, ...others }: SliderProps): JSX.Element;

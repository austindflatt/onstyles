...
declare const _default: (params: NumberInputStyles, options?: import("@mantine/styles/lib/tss/create-styles").UseStylesOptions<"rightSection" | "control" | "controlUp" | "controlDown">) => {

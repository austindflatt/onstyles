...
export declare type TimelineItemStylesNames = ClassNames<typeof useStyles>;
...
export declare function TimelineItem({ className, bullet, title, bulletSize, lineWidth, active, lineActive, classNames, styles, children, color, align, lineVariant, sx, ...others }: TimelineItemProps): JSX.Element;

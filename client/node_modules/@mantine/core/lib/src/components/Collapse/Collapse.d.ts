...
export declare function Collapse({ children, in: opened, transitionDuration, transitionTimingFunction, style, sx, className, onTransitionEnd, animateOpacity, ...others }: CollapseProps): JSX.Element;

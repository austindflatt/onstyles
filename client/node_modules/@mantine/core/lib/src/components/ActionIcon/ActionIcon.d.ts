...
export declare type ActionIconProps<C extends React.ElementType> = PolymorphicComponentProps<C, _ActionIconProps>;
declare type ActionIconComponent = <C extends React.ElementType = 'button'>(props: ActionIconProps<C>) => React.ReactElement;

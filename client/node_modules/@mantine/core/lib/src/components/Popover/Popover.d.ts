...
export interface PopoverProps extends Omit<DefaultProps<PopoverStylesNames>, MantineMargin>, SharedPopperProps, Omit<React.ComponentPropsWithoutRef<'div'>, 'title'> {
...
export declare function Popover({ className, children, target, title, onClose, opened, zIndex, arrowSize, withArrow, transition, transitionDuration, transitionTimingFunction, gutter, position, placement, disabled, noClickOutside, noFocusTrap, noEscape, withCloseButton, radius, spacing, shadow, closeButtonLabel, positionDependencies, id, classNames, styles, sx, ...others }: PopoverProps): JSX.Element;

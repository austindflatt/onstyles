...
export declare type ColorSwatchProps<C extends React.ElementType> = PolymorphicComponentProps<C, _ColorSwatchProps>;
declare type ColorSwatchComponent = <C extends React.ElementType = 'div'>(props: ColorSwatchProps<C>) => React.ReactElement;

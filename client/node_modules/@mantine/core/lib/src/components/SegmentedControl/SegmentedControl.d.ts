...
export declare function SegmentedControl({ className, style, data: _data, name, value, onChange, color, fullWidth, radius, size, transitionDuration, transitionTimingFunction, classNames, styles, defaultValue, sx, ...others }: SegmentedControlProps): JSX.Element;

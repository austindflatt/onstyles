...
function getSelectRightSectionProps(_a) {
  ...
  return {
    rightSectionWidth: getSizeValue({ size: props.size, sizes: RIGHT_SECTION_WIDTH }),
    rightSection: /* @__PURE__ */ React.createElement(SelectRightSection, __spreadValues({}, props)),
    styles: __spreadProps(__spreadValues({}, styles), {
      rightSection: __spreadProps(__spreadValues({}, styles == null ? void 0 : styles.rightSection), {

import { createStyles, getSizeValue, getThemeColor, getFocusStyles, getFontStyles } from '@mantine/styles';
...
var useStyles = createStyles((theme, { size, color }, getRef) => {
  ...
  return {
    ...
    radio: __spreadProps(__spreadValues({}, getFocusStyles(theme)), {

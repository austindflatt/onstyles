import { createStyles, getSizeValue, getThemeColor, getFontStyles, getFocusStyles, hexToRgba, getSharedColorScheme } from '@mantine/styles';
...
var useStyles = createStyles((theme, { color, size, radius }) => ({
  root: __spreadProps(__spreadValues(__spreadValues({}, getFocusStyles(theme)), getFontStyles(theme)), {
    position: "relative",
    appearance: "none",

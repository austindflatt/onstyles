import { createStyles, getFocusStyles, getFontStyles, getThemeColor } from '@mantine/styles';
...
var useStyles = createStyles((theme, { color, orientation }, getRef) => {
  ...
  return {
    tabActive,
    tabLabel: {},
    tabControl: __spreadProps(__spreadValues(__spreadValues({}, getFontStyles(theme)), getFocusStyles(theme)), {

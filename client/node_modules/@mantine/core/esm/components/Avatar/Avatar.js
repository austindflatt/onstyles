...
const Avatar = forwardRef((_a, ref) => {
  ...
  const { classes, cx } = useStyles({ color, radius, size }, { classNames, styles, sx, name: "Avatar" });
  ...
  return /* @__PURE__ */ React.createElement(Element, __spreadProps(__spreadValues({}, rest), {

...
const ICON_SIZE = 24;
var useStyles = createStyles((theme, { transitionDuration, disableIconRotation, iconPosition }, getRef) => {
  const icon = {
    ref: getRef("icon"),
  ...
  return {
    ...
    control: __spreadProps(__spreadValues(__spreadValues({}, getFocusStyles(theme)), getFontStyles(theme)), {
      width: "100%",
      display: "flex",
      alignItems: "center",
    ...
    content: __spreadProps(__spreadValues({}, getFontStyles(theme)), {

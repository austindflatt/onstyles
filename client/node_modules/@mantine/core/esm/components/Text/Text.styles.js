import { createStyles, getSharedColorScheme, getFontStyles, getFocusStyles } from '@mantine/styles';
...
var useStyles = createStyles((theme, {
  ...
  return {
    root: __spreadProps(__spreadValues(__spreadValues(__spreadValues({}, getFontStyles(theme)), getFocusStyles(theme)), getLineClamp(lineClamp)), {

import { createStyles, getSizeValue, getFontStyles } from '@mantine/styles';
...
var useStyles = createStyles((theme, { size, multiline, radius, variant, invalid, disabled }) => {
  ...
  return {
    ...
    input: variant === "headless" ? {} : __spreadValues(__spreadProps(__spreadValues(__spreadValues(__spreadProps(__spreadValues(__spreadValues({}, getFontStyles(theme)), getVariantStyles({ variant, theme })), {
      height: multiline ? variant === "unstyled" ? void 0 : "auto" : getSizeValue({ size, sizes }),

import { createStyles, hexToRgba, getSizeValue, getSharedColorScheme, getFontStyles, getFocusStyles, getThemeColor } from '@mantine/styles';
...
var useStyles = createStyles((theme, {
  ...
  const loading = {
    ...
    "&::before": {
      ...
      right: -1,
      bottom: -1,
      backgroundColor: theme.colorScheme === "dark" ? hexToRgba(theme.colors.dark[7], 0.5) : "rgba(255, 255, 255, .5)",
  ...
  return {
    ...
    root: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, getSizeStyles({ compact, size })), getFontStyles(theme)), getFocusStyles(theme)), getWidthStyles(fullWidth)), {

...
const Navbar = forwardRef((_a, ref) => {
  ...
  const { classes, cx } = useStyles({ width, height, padding, fixed, position, hiddenBreakpoint, zIndex }, { classNames, styles, sx, name: "Navbar" });
  const { mergedStyles, rest } = useExtractedMargins({ others, style });
  return /* @__PURE__ */ React.createElement("nav", __spreadValues({
    ref,

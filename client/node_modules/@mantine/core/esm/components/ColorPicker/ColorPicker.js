...
import { useExtractedMargins, getSizeValue } from '@mantine/styles';
...
const ColorPicker = forwardRef((_a, ref) => {
  ...
  const { classes, cx } = useStyles({ size, fullWidth }, { classNames, styles, sx, name: __staticSelector });
  ...
  return /* @__PURE__ */ React.createElement("div", __spreadValues({
    ...
    style: mergedStyles,
    ref
  }, rest), withPicker && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Saturation, {
    value: parsed,

...
const Menu = React.forwardRef((_a, ref) => {
  ...
  const { classes } = Menu_styles['default'](null, { classNames, styles, name: "Menu" });
  ...
  hooks.useClickOutside(() => _opened && handleClose(), null, [dropdownElement, wrapperElement]);
  const toggleMenu = () => {
  ...
  }, /* @__PURE__ */ React__default.createElement(MenuBody.MenuBody, __spreadProps(__spreadValues({}, menuBodyProps), {
    opened: _opened,
    onClose: handleClose,
    id: uuid,
    closeOnItemClick,

...
var useStyles = styles.createStyles((theme, { gutter, grow, offset, columns, span, xs, sm, md, lg, xl }) => ({
  root: __spreadValues({
    boxSizing: "border-box",
    flexGrow: grow ? 1 : 0,
    padding: styles.getSizeValue({ size: gutter, sizes: theme.spacing }) / 2,
    marginLeft: offset ? `${100 / (columns / offset)}%` : void 0,

...
function Marks({
  ...
  const { classes, cx } = Marks_styles['default']({ size, color }, { classNames, styles, name: "Slider" });
  const items = marks.map((mark, index) => /* @__PURE__ */ React__default.createElement("div", {
    className: classes.markWrapper,
    style: { left: `${getPosition.getPosition({ value: mark.value, min, max })}%` },
    key: index

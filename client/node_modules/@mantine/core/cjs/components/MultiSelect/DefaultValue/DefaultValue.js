...
var DefaultValue_styles = require('./DefaultValue.styles.js');
...
function DefaultValue(_a) {
  ...
  const { classes, cx } = DefaultValue_styles['default']({ size, disabled, radius }, { classNames, styles, name: "MultiSelect" });
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    className: cx(classes.defaultValue, className)
  }, others), /* @__PURE__ */ React__default.createElement("span", {
    className: classes.label
  }, label), !disabled && /* @__PURE__ */ React__default.createElement(CloseButton.CloseButton, {
    "aria-hidden": true,
    onClick: onRemove,

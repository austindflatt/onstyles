...
var groupSortData = require('../Select/group-sort-data/group-sort-data.js');
...
const MultiSelect = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = MultiSelect_styles['default']({ size, invalid: !!error }, { classNames, styles: styles$1, name: "MultiSelect" });
  ...
  const sortedData = groupSortData.groupSortData({ data: formattedData });

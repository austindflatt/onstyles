...
const TypographyStylesProvider = React.forwardRef((_a, ref) => {
  var _b = _a, { className, style, sx } = _b, others = __objRest(_b, ["className", "style", "sx"]);
  const { classes, cx } = TypographyStylesProvider_styles['default'](null, { sx, name: "TypographyStylesProvider" });

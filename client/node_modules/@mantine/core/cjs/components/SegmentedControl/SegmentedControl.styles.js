...
var useStyles = styles.createStyles((theme, {
  ...
  const label = __spreadProps(__spreadValues(__spreadValues({
    ref: getRef("label")
  }, styles.getFocusStyles(theme)), styles.getFontStyles(theme)), {
  ...
  return {
    ...
    active: {
      ...
      backgroundColor: color in theme.colors ? styles.getThemeColor({ theme, color, shade: 6 }) : theme.colorScheme === "dark" ? theme.colors.dark[5] : theme.white
    }
  };
});

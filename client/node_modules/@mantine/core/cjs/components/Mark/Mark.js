...
const Mark = React.forwardRef((_a, ref) => {
  var _b = _a, { color = "yellow", style, sx, className } = _b, others = __objRest(_b, ["color", "style", "sx", "className"]);
  ...
  return /* @__PURE__ */ React__default.createElement("mark", __spreadValues({
    ref,
    style: mergedStyles,
    className: cx(css({

...
var useStyles = styles.createStyles((theme, { radius, size }) => ({
  ...
  control: {
    ...
    width: styles.getSizeValue({ size, sizes: CONTROL_SIZES }),
    padding: 0,
  ...
  controlUp: {
    borderTopRightRadius: styles.getSizeValue({ size: radius, sizes: theme.radius }) - 1,
    "&::after": {
  ...
  controlDown: {
    borderBottomRightRadius: styles.getSizeValue({ size: radius, sizes: theme.radius }) - 1,
    borderBottom: 0,
    "&::after": {

...
function AccordionItem(_a) {
  ...
  const { sxClassName } = styles.useSx({ sx });
  const { classes, cx } = AccordionItem_styles['default']({ transitionDuration: duration, disableIconRotation, iconPosition }, { classNames, styles: styles$1, name: "Accordion" });
  hooks.useWindowEvent("resize", () => forceUpdate());
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    className: cx(classes.item, { [classes.itemOpened]: opened }, sxClassName, className)
  }, others), /* @__PURE__ */ React__default.createElement(UnstyledButton.UnstyledButton, {

...
const Code = React.forwardRef((_a, ref) => {
  var _b = _a, { className, children, block = false, color, style, sx } = _b, others = __objRest(_b, ["className", "children", "block", "color", "style", "sx"]);
  const theme = styles.useMantineTheme();
  const themeColor = color || (theme.colorScheme === "dark" ? "dark" : "gray");
  const { classes, cx } = Code_styles['default']({ color: themeColor }, { name: "Code", sx });

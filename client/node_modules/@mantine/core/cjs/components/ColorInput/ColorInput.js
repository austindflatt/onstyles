...
const ColorInput = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = ColorInput_styles['default']({ disallowInput }, { classNames, styles: styles$1, name: "ColorInput" });
  ...
  return /* @__PURE__ */ React__default.createElement(InputWrapper.InputWrapper, __spreadValues({
    ...
    arrowStyle: { left: styles.getSizeValue({ size, sizes: ARROW_OFFSET }) }

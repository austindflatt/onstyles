...
const Pagination = React.forwardRef((_a, ref) => {
  var _b = _a, {
    itemComponent: Item = DefaultItem.DefaultItem,
    classNames,
    styles: styles$1,
    page,
    initialPage = 1,
  ...
  const { classes, cx } = Pagination_styles['default']({ color, size, radius }, { classNames, styles: styles$1, name: "Pagination" });
  ...
  return /* @__PURE__ */ React__default.createElement(Group.Group, __spreadValues({
    spacing: spacing || styles.getSizeValue({ size, sizes: theme.spacing }) / 2,
    ref,
    sx

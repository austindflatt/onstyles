...
const Checkbox = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = Checkbox_styles['default']({ size, color, transitionDuration }, { classNames, styles: styles$1, sx, name: "Checkbox" });
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    ...
    onChange,
    disabled
  }, rest)), /* @__PURE__ */ React__default.createElement(CheckboxIcon.CheckboxIcon, {
    indeterminate,

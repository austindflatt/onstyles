...
var useStyles = styles.createStyles((theme, { color, orientation }, getRef) => {
  const tabActive = { ref: getRef("tabActive") };
  return {
    tabActive,
    tabLabel: {},
    tabControl: __spreadProps(__spreadValues(__spreadValues({}, styles.getFontStyles(theme)), styles.getFocusStyles(theme)), {
    ...
    default: {
      ...
      [`&.${tabActive.ref}`]: {
        color: styles.getThemeColor({ theme, color, shade: theme.colorScheme === "dark" ? 4 : 7 }),
        [orientation === "horizontal" ? "borderBottomColor" : "borderRightColor"]: styles.getThemeColor({
          theme,
          color,

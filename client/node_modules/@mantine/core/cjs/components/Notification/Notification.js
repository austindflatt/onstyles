...
const Notification = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = Notification_styles['default']({ color, disallowClose }, { sx, classNames, styles: styles$1, name: "Notification" });
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    ...
    style: mergedStyles,
    ref
  }, rest), icon && !loading && /* @__PURE__ */ React__default.createElement("div", {

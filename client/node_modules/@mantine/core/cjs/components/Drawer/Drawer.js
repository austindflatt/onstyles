...
function MantineDrawer(_a) {
  ...
  const { classes, cx } = Drawer_styles['default']({ size, position }, { sx, classNames, styles: styles$1, name: "Drawer" });
  ...
  return /* @__PURE__ */ React__default.createElement(GroupedTransition.GroupedTransition, {
    ...
    "aria-modal": true,
    style
  }, others), !noCloseOnClickOutside && /* @__PURE__ */ React__default.createElement("div", {
    onClick: onClose,

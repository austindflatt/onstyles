...
function TimelineItem(_a) {
  ...
  const { classes, cx } = TimelineItem_styles['default']({ bulletSize, color, align, lineVariant, lineWidth }, { classNames, styles: styles$1, name: "Timeline" });
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    className: cx(classes.item, { [classes.itemLineActive]: lineActive, [classes.itemActive]: active }, sxClassName, className)

...
var useStyles = styles.createStyles((theme, { bulletSize, color, align, lineVariant, lineWidth }, getRef) => {
  ...
  return {
    ...
    itemLineActive: {
      "&::before": {
        borderLeftColor: styles.getThemeColor({
          theme,
          color,
    ...
    itemActive: {
      [`& .${itemBullet.ref}`]: {
        borderColor: styles.getThemeColor({
          theme,
          color,
          shade: theme.colorScheme === "light" ? 6 : 7
        }),

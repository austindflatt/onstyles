...
var useStyles = styles.createStyles((theme, { size }, getRef) => {
  const position = -styles.getSizeValue({ size, sizes: Thumb_styles.THUMB_SIZES }) / 2 - 1;
  ...
  return {
    ...
    saturation: {
      ...
      position: "relative",
      height: styles.getSizeValue({ size, sizes: SATURATION_HEIGHTS }),
      borderRadius: theme.radius.sm,
      margin: styles.getSizeValue({ size, sizes: Thumb_styles.THUMB_SIZES }) / 2,

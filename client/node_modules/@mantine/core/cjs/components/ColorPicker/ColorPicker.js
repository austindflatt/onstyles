...
const ColorPicker = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = ColorPicker_styles['default']({ size, fullWidth }, { classNames, styles: styles$1, sx, name: __staticSelector });
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    ...
    style: mergedStyles,
    ref
  }, rest), withPicker && /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(Saturation.Saturation, {
    value: parsed,
    ...
    color: _value,
    radius: "sm",
    size: styles.getSizeValue({ size, sizes: SWATCH_SIZES }),

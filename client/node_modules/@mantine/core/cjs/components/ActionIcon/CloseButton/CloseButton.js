...
var ActionIcon = require('../ActionIcon.js');
...
const CloseButton = React.forwardRef((_a, ref) => {
  var _b = _a, { iconSize, size = "md" } = _b, others = __objRest(_b, ["iconSize", "size"]);
  const _iconSize = iconSize || styles.getSizeValue({ size, sizes: iconSizes });
  return /* @__PURE__ */ React__default.createElement(ActionIcon.ActionIcon, __spreadValues({
    size,
    ref
  }, others), /* @__PURE__ */ React__default.createElement(CloseIcon.CloseIcon, {

...
const RingProgress = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = RingProgress_styles['default'](null, { sx, classNames, styles: styles$1, name: "RingProgress" });
  const { mergedStyles, rest } = styles.useExtractedMargins({ others, style });
  const curves = getCurves.getCurves({ size, thickness, sections }).map((curve, index) => {
    var _a2, _b2;
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    style: __spreadValues({ width: size, height: size }, mergedStyles),

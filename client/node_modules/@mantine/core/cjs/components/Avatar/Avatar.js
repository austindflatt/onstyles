...
const Avatar = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = Avatar_styles['default']({ color, radius, size }, { classNames, styles: styles$1, sx, name: "Avatar" });
  ...
  return /* @__PURE__ */ React__default.createElement(Element, __spreadProps(__spreadValues({}, rest), {

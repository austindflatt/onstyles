...
const Divider = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = Divider_styles['default']({ color: _color, size, variant }, { classNames, styles: styles$1, sx, name: "Divider" });
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    ...
    style: mergedStyles
  }, rest), !!label && horizontal && /* @__PURE__ */ React__default.createElement(Text.Text, __spreadProps(__spreadValues({}, labelProps), {
    color: _color,

...
function CardSection(_a) {
  var _b = _a, { className, padding = 0 } = _b, others = __objRest(_b, ["className", "padding"]);
  const { classes, cx } = CardSection_styles['default']({ padding }, { name: "Card" });

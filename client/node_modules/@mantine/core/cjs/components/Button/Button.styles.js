...
var useStyles = styles.createStyles((theme, {
  ...
  const loading = {
    ...
    "&::before": {
      ...
      right: -1,
      bottom: -1,
      backgroundColor: theme.colorScheme === "dark" ? styles.hexToRgba(theme.colors.dark[7], 0.5) : "rgba(255, 255, 255, .5)",
      borderRadius: styles.getSizeValue({ size: radius, sizes: theme.radius }) - 1,
      cursor: "not-allowed"
    }
  };
  ...
  return {
    ...
    root: __spreadProps(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, getSizeStyles({ compact, size })), styles.getFontStyles(theme)), styles.getFocusStyles(theme)), getWidthStyles(fullWidth)), {
    ...
    link: {
      ...
      color: styles.getThemeColor({ theme, color, shade: theme.colorScheme === "dark" ? 3 : 7 }),
      cursor: "pointer",
      height: "auto",

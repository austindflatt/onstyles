...
const NavbarSection = React.forwardRef((_a, ref) => {
  var _b = _a, { component, children, grow = false, style, className, sx } = _b, others = __objRest(_b, ["component", "children", "grow", "style", "className", "sx"]);
  const Element = component || "div";
  const { mergedStyles, rest } = styles.useExtractedMargins({ others, style });
  const { css, cx, sxClassName } = styles.useSx({ sx, className });

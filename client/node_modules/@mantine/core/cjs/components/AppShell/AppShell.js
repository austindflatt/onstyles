...
function getNavbarWidth(element) {
  var _a, _b;
...
function getNavbarBreakpoints(element, theme) {
  var _a, _b;
  const breakpoints = (_b = (_a = element == null ? void 0 : element.props) == null ? void 0 : _a.width) == null ? void 0 : _b.breakpoints;
...
const AppShell = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = AppShell_styles['default']({
    ...
    navbarBreakpoints,
    navbarOffsetBreakpoint
  }, { styles: styles$1, classNames, sx, name: "AppShell" });

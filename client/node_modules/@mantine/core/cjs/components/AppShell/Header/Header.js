...
const Header = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = Header_styles['default']({ height, padding, fixed, position, zIndex }, { name: "Header", sx });
  return /* @__PURE__ */ React__default.createElement("nav", __spreadValues({

...
var useStyles = styles.createStyles((theme, { size }) => ({
  item: {
    ...
    textAlign: "left",
    width: "100%",
    padding: `${styles.getSizeValue({ size, sizes: theme.spacing }) / 1.5}px ${styles.getSizeValue({
      size,
      sizes: theme.spacing
    })}px`,
    cursor: "pointer",
  ...
  nothingFound: {
    ...
    paddingTop: styles.getSizeValue({ size, sizes: theme.spacing }) / 2,
    paddingBottom: styles.getSizeValue({ size, sizes: theme.spacing }) / 2,
    textAlign: "center"
  },
  disabled: {
    cursor: "default",

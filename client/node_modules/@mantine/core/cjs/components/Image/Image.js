...
const Image = React.forwardRef((_a, ref) => {
  ...
  const { classes, cx } = Image_styles['default']({ radius }, { sx, classNames, styles: styles$1, name: "Image" });
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    ...
    style: __spreadValues({ width, height }, mergedStyles),
    ref
  }, rest), isPlaceholder && /* @__PURE__ */ React__default.createElement("div", {
  ...
  }, imageProps)), !!caption && /* @__PURE__ */ React__default.createElement(Text.Text, {
